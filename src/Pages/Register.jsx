  ...
  return (
    <div className="flex  bg-pink-300 justify-center items-center min-h-screen">
      ...
      <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
        ...
        <form onSubmit={handleRegister} className="card-body">
          <fieldset className="fieldset">
            ...
            <button onClick={handleTogglePasswordShow}
             className="absolute right-7 btn-xs top-2 btn">{showPassword? <FaEyeSlash />:<FaEye></FaEye>}</button>
            </div>
            {passwordError && (
        ...
        {/* Google */}
<button onClick={handleSignInWithGoogle} className="btn hover:bg-black hover:text-white bg-white text-black border-[#e5e5e5]">
